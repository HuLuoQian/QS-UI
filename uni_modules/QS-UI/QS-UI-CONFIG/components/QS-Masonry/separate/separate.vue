<template>
	<view class="QS-Masonry-Template">
		<view class="QS-Masonry-Template-item" :id="pre_id + index" :style="{ 'margin-bottom': itemSpace }" v-for="(item, index) in (String(hideTem) === 'true'?hideList:list)" :key="index">
			<block v-if="type==='integralShop'">
