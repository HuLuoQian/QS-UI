...
<script>
	...
	import pickerDate from '../QS-PickerDate-select/QS-PickerDate-select.vue';
	...
	import props from '@/QS-UI-CONFIG/components/QS-PickerDate/js/props.js';
	...
	export default {
		...
		computed: {
			QS_nCompClass() {
				return 'QS width100 borderBottom1pxf2f2f2';
			}
		}
	};
</script>
