			...
			<view class="flex_row width100">
						<block v-if="linkage">
							<block v-if="linkageNum == 2">
								<view class="flex_row_e_c padding-rpx_10_15 Flex8" :class="nValue.data && nValue.data.steps1 && nValue.data.steps2?'':'fontColor666666'">
									{{
							...
							<block v-if="linkageNum == 3">
								<view class="flex_row_e_c padding-rpx_10_15 Flex8" :class="nValue.data && nValue.data.steps1 && nValue.data.steps2 && nValue.data.steps3?'':'fontColor666666'">
									{{
						...
						<block v-else>
							...
							<block v-else>
								<view class="flex_row_e_c padding-rpx_10_15 Flex8 fontColor666666">
									{{placherhold}}
								</view>
							</block>
						</block>
